 ...
 */
#if 0 // TODO: GcScheduling with OMR
...
class GCRuntime
{
  ...
  private:
    ...
    // Allocator internals
#if 0 // OMRTODO: What are these and do we need them?
...
#if 0 // OMRTODO: Incremental slices with the concurrent GC
...
#if 0
// OMRTODO: Support heap iteration
